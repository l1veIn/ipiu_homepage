...
export const navigation = [
  {
    ...
    links: [
      ...
      { title: '远程访问', href: '/remote' },
      { title: '安装Pytorch', href: '/pytorch' },
      { title: '常见问题FAQ', href: '/FAQ' },
    ],
  },
  {
    title: '资源',
    links: [
      { title: '常用工具', href: '/tools' },
      { title: '视频教程', href: '/video' },
      { title: '数据集', href: '/messages' },
      { title: '模型', href: '/model' },
      { title: '组内源码', href: '/code' },
      { title: '百度网盘超会', href: '/baidupan' },
      { title: '论文模版', href: '/latex' },
      { title: '组会PPT模版', href: '/ppt' },
      { title: '聚餐地点推荐', href: '/food' },
      { title: '其他攻略', href: '/others' },
    ],
  },
]
