...
function SmallPrint() {
  return (
    <div className="flex flex-col items-center justify-between gap-5 pt-8 border-t border-zinc-900/5 sm:flex-row dark:border-white/5">
      <p className="text-xs text-zinc-600 dark:text-zinc-400">
        &copy; Copyright {new Date().getFullYear()}. All rights reserved.
      </p>
      <a href='https://beian.miit.gov.cn/' className="text-xs text-zinc-600 dark:text-zinc-400">
        &copy; 陕ICP备2021000195号-1
      </a>
